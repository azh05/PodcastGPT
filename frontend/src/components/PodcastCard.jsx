...
export default function PodcastCard({ title, status, coverImageUrl, onPlay, onRegenerate }) {
        ...
        {failed && onRegenerate && (
          ...
          >
            <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h4.5M20 20v-5h-4.5M4.5 9A8 8 0 0119.5 15M19.5 15A8 8 0 014.5 9" />
            </svg>
          </button>
        )}
      </div>
